...
:::{figure} /content/figures/StickyExpectationsC/bPlot.png
:name: fig:epidshock
...
:::{figure} /content/figures/StickyExpectationsC/StickyExpectationsCc.png
:name: fig:StickyExpectationsCc

Path of {math}`\CLev` after a shock {math}`\TShkEmp_{t}=2`; Sticky Expectations in Red/Gray
:::

:::{figure} /content/figures/StickyExpectationsC/StickyExpectationsCb.png
