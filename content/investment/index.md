...
Abel and Hayashi cure the indeterminacy by making adjustment costly. The shadow value of
installed capital, {math}`q`, then becomes the state variable governing investment. The
chapter closes with imperfect capital markets, which break the separation between a
firm's investment decision and its financial position, and so explain why cash flow
helps predict investment even after controlling for {math}`q`.
