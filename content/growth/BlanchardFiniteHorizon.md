...
Blanchard {cite:p}`blanchardFinite`, is to assume that the economy
...
:::{solution} ex:blanchard-obj-func
:class: dropdown
...
:::{solution} ex:blanchard-population
:class: dropdown
...
:::{exercise}
:label: ex:blanchard-growth-rate
...
:::{solution} ex:blanchard-growth-rate
:class: dropdown
...
:::{exercise}
:label: ex:blanchard-consumption
...
:::{solution} ex:blanchard-consumption
:class: dropdown
...
:::{exercise}
:label: ex:blanchard-agg-consumption
...
:::{solution} ex:blanchard-agg-consumption
:class: dropdown
```{math}
\begin{gathered}\begin{aligned}
        C(t) & =   \int_{-\infty}^{t} \pDies c(\tThen,t) \Alive_{\tThen}^{t} d\tThen \\
...
<!-- \ifthenelse{\boolean{AnswersTF}}{true: show answer}{false: hide answer} -->
...
:::{solution} ex:blanchard-cdot-locus
:class: dropdown
...
:::{solution} ex:blanchard-phase-diag
:class: dropdown
...
> ```
>
> :::{figure} /content/growth/BlanchardFiniteHorizon/LaTeX/Figures/BlanchardFiniteHorizPhase1.png
> :::
>
...
:::{exercise}
:label: ex:blanchard-fiscal-impact
Explain why the effect of this policy is to modify the aggregate

specification of the economy to (see top of next page)
...
:::{solution} ex:blanchard-fiscal-impact
:class: dropdown
...
:::{exercise}
:label: ex:blanchard-new-dynamics
...
:::{solution} ex:blanchard-new-dynamics
:class: dropdown
...
> generations.
>
> :::{figure} /content/growth/BlanchardFiniteHorizon/LaTeX/Figures/BlanchardFiniteHorizPhase2.png
> :::
>
...
>
> :::{figure} /content/growth/BlanchardFiniteHorizon/LaTeX/Figures/BlanchardCDynamics.png
> :::
...
:::{exercise}
:label: ex:blanchard-neg-interest
...
:::{solution} ex:blanchard-neg-interest
:class: dropdown
...
>
> :::{figure} /content/growth/BlanchardFiniteHorizon/LaTeX/Figures/BlanchardFiniteHorizPhase3.png
> :::
