...
ARTIFACT_EXT = {
    ".aux", ".log", ".out", ".bbl", ".blg", ".toc", ".lof", ".lot", ".fls",
    ".fdb_latexmk", ".synctex.gz", ".xbb", ".def", ".vrb", ".upa", ".upb", ".cuts",
    ".dep", ".idx", ".ilg", ".ind", ".nav", ".snm", ".4ht", ".4ct", ".4tc", ".mk4",
    ".idv", ".lg", ".xref", ".tmp", ".dvi", ".ps", ".svg", ".html", ".htm", ".css",
    ".sty", ".cls", ".bst", ".cnf", ".cfg", ".texmf", ".el", ".title", ".zip", ".db",
    ".webloc", ".old", ".bat", ".rel", ".fff", ".txsprofile",
}
...
if args.fetch:
    ...
    for section, part, stem in pdf_only:
        ...
        log.info("fetched %s -> %s (%d bytes, PDF is the source)", stem, out,
                 out.stat().st_size)
