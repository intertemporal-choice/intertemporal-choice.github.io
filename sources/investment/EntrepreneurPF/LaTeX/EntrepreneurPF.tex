...
%\usepackage{mathtools}\mathtoolsset{showonlyrefs} % Show equation numbers only on equations that are actually referenced somewhere in the text
...
\provideboolean{NumericalSolution}  \setboolean{NumericalSolution}{false}
%\provideboolean{NumericalSolution}  \setboolean{NumericalSolution}{true}

\provideboolean{Taxes}
%\setboolean{Taxes}{true} % To include taxes set Taxes to true
\setboolean{Taxes}{false}
...
% To make the handout version of this document, set AnswersTF to true
% and Exam to false
...
\renewcommand{\answer}[2]{\ifthenelse{\boolean{AnswersTF}}{
\begin{quote}
#1
\end{quote}
}
